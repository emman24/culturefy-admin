...
import TableHeader from 'src/views/apps/position-goals/components/TableHeader'
import Table from 'src/views/apps/position-goals/components/Table'
import Drawer from 'src/views/apps/position-goals/components/Drawer'
