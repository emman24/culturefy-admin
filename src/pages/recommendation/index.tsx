...
import TableHeader from 'src/views/apps/recommendations/components/TableHeader'
import Table from 'src/views/apps/recommendations/components/Table'
import Drawer from 'src/views/apps/recommendations/components/Drawer'
