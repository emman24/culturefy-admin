...
import TableHeader from 'src/views/apps/course/components/TableHeader'
import Table from 'src/views/apps/course/components/Table'
import Drawer from 'src/views/apps/course/components/Drawer'
