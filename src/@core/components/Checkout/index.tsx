...
const stripePromise = loadStripe("pk_test_51MFR2TIadObZ2b5rMClrfGQqKXqrJD3ZwO7Oy3THjAVxmsNifhkcNVLkCVOZyn5hVyonASBfle6A4MDgDkJCqF0Q00TsDGn1Rg");
        ...
        <Fragment>
            {
                (paymentIntent) ? (
                    ...
                    <ShippingDetailsForm onSubmitShipping={(shipping) => createPaymentIntentHandler(shipping)} />
                )
            }
        </Fragment>
    )
